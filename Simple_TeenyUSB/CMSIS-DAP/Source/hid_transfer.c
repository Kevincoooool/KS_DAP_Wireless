...
//  * @LastEditTime: 2020-08-21 20:05:25
//  * @FilePath: \Simple_TeenyUSB\CMSIS-DAP\Source\hid_transfer.c
//  */
// /***************************************************************/
...
// 	}
// #elif WIRELESS_TX
// 	//处理数据过程中，将HID收到的数据转发给SPI(NRF)后，
// 	//需要等待SPI返回的数据再发送给HID发出
// 	if (dealing_data)
// 	{
// 		// DAP_ProcessCommand(MYUSB_Request, MYUSB_Response);
// 		// tusb_hid_device_send(&hid_dev, MYUSB_Response, DAP_PACKET_SIZE);
