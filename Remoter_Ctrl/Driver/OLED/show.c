...
//	{
//		show_mode = 1;
//		for(u8 i=0;i<12;i++) OLED_Show_CH_String(Line1_Begin+i*6,Y0,oled_CH21[i],12,show_mode);
//	}
//	else if(Show.Set_Fail)//设置失败
//	{
//		show_mode = 1;
//		for(u8 i=0;i<12;i++) OLED_Show_CH_String(Line1_Begin+i*6,Y0,oled_CH22[i],12,show_mode);
//	}
...
//		}
//		
//		for(u8 i=0;i<12;i++) OLED_Show_CH_String(Line1_Begin+i*6,Y0,oled_CH24[i],12,show_mode);
//	}
//	else
//	{
...
void OLED_Show_Seting(void)
{
	...
	switch(page)
	{
		...
		case 1:
			...
			cnt+=13;
			for(u8 i=0;i<10;i++) OLED_Show_CH_String(0+i*6,cnt,oled_CH20[i],12,1);
			if(set_bit==bit_cnt)	mode=0; else mode=1;
...
void OLED_Show_Test(void)
{
	...
	switch(page)
	{
		case 0:
			...
			cnt+=13;
			for(u8 i=0;i<8;i++) OLED_Show_CH_String(0+i*6,cnt,oled_CH23[i],12,1);
			if(test_bit==bit_cnt++) mode=0; else mode=1;
			if( test_temp&BIT7 )for(u8 i=0;i<4;i++) OLED_Show_CH_String(104+i*6,cnt,oled_CH10[i],12,mode);
			else								for(u8 i=0;i<4;i++) OLED_Show_CH_String(104+i*6,cnt,oled_CH11[i],12,mode);
		break;
		...
		case 1:
			...
			cnt+=13;
			for(u8 i=0;i<9;i++) OLED_Show_CH_String(0+i*6,cnt,oled_CH25[i],12,1);
			if(test_bit==bit_cnt++) mode=0; else mode=1;
			if( test_temp&BIT9 )for(u8 i=0;i<4;i++) OLED_Show_CH_String(104+i*6,cnt,oled_CH10[i],12,mode);
			else								for(u8 i=0;i<4;i++) OLED_Show_CH_String(104+i*6,cnt,oled_CH11[i],12,mode);
		break;
