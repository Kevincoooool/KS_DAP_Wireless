...
#define  COMP_STRING_DESCRIPTOR2_STR   "KSDIY 996 CMSIS-DAP"
#define  COMP_STRING_DESCRIPTOR2_SIZE   (40)
WEAK __ALIGN_BEGIN  const uint8_t COMP_StringDescriptor2 [40] __ALIGN_END = {
  0x28,                                             /* bLength */
  USB_STRING_DESCRIPTOR_TYPE,                       /* bDescriptorType */
  'K', 0x00,                                        /* wcChar0 */
  'S', 0x00,                                        /* wcChar1 */
...
#define  COMP_STRING_DESCRIPTOR4_STR   "KSDIY 996 CMSIS-DAP V2"
#define  COMP_STRING_DESCRIPTOR4_SIZE   (46)
WEAK __ALIGN_BEGIN  const uint8_t COMP_StringDescriptor4 [46] __ALIGN_END = {
  0x2e,                                             /* bLength */
  USB_STRING_DESCRIPTOR_TYPE,                       /* bDescriptorType */
  'K', 0x00,                                        /* wcChar0 */
  'S', 0x00,                                        /* wcChar1 */
