...
//// EndPoints 2 defines
//#define COMP_EP2_RX_SIZE                                    (64)
//#define COMP_EP2_RX_ADDR                                    (COMP_USB_BUF_START + (192))
//#define COMP_EP2_TX_SIZE                                    (64)
//#define COMP_EP2_TX_ADDR                                    (COMP_USB_BUF_START + (256))
...
//#define COMP_EP2_TX1_ADDR                                   (COMP_USB_BUF_START + (256))
//#define COMP_EP2_RX0_ADDR                                   (COMP_USB_BUF_START + (192))
//#define COMP_EP2_RX1_ADDR                                   (COMP_USB_BUF_START + (256))

//// EndPoints 3 defines
//#define COMP_EP3_RX_SIZE                                    (64)
//#define COMP_EP3_RX_ADDR                                    (COMP_USB_BUF_START + (320))
//#define COMP_EP3_TX_SIZE                                    (64)
//#define COMP_EP3_TX_ADDR                                    (COMP_USB_BUF_START + (384))
...
//#define COMP_EP3_TX1_ADDR                                   (COMP_USB_BUF_START + (384))
//#define COMP_EP3_RX0_ADDR                                   (COMP_USB_BUF_START + (320))
//#define COMP_EP3_RX1_ADDR                                   (COMP_USB_BUF_START + (384))

//// EndPoints 4 defines
//#define COMP_EP4_RX_SIZE                                    (64)
//#define COMP_EP4_RX_ADDR                                    (COMP_USB_BUF_START + (448))
//#define COMP_EP4_TX_SIZE                                    (64)
//#define COMP_EP4_TX_ADDR                                    (COMP_USB_BUF_START + (512))
//#define COMP_EP4_RX_TYPE                                    USB_EP_BULK
//#define COMP_EP4_TX_TYPE                                    USB_EP_BULK

//#define COMP_EP4_TYPE                                       USB_EP_BULK
//#define COMP_EP4_TX0_ADDR                                   (COMP_USB_BUF_START + (448))
//#define COMP_EP4_TX1_ADDR                                   (COMP_USB_BUF_START + (512))
//#define COMP_EP4_RX0_ADDR                                   (COMP_USB_BUF_START + (448))
//#define COMP_EP4_RX1_ADDR                                   (COMP_USB_BUF_START + (512))
...
//{ COMP_EP0_TX_SIZE, COMP_EP1_TX_SIZE, COMP_EP2_TX_SIZE, 0, COMP_EP4_TX_SIZE,  };
//extern const uint8_t COMP_rxEpMaxSize[];
//#define COMP_RXEP_MAX_SIZE                                  \
//const uint8_t COMP_rxEpMaxSize[] = \
//{ COMP_EP0_RX_SIZE, COMP_EP1_RX_SIZE, COMP_EP2_RX_SIZE, 0, COMP_EP4_RX_SIZE,  };
...
//// RX FIFO size / 4 > (CONTROL_EP_NUM * 5 + 8) +  (MAX_OUT_SIZE / 4 + 1) + (OUT_EP_NUM*2) + 1 = 37
...
//#define COMP_EP3_TX_FIFO_ADDR_FS                            (896)
//#define COMP_EP3_TX_FIFO_SIZE_FS                            (COMP_EP3_TX_SIZE * 4)
//#define COMP_EP4_TX_FIFO_ADDR_FS                            (1152)
...
#define COMP_EP4_TX_SIZE                                    (64)
#define COMP_EP4_TX_ADDR                                    (COMP_USB_BUF_START + (384))
#define COMP_EP4_RX_TYPE                                    USB_EP_BULK
#define COMP_EP4_TX_TYPE                                    USB_EP_BULK

#define COMP_EP4_TYPE                                       USB_EP_BULK
#define COMP_EP4_TX0_ADDR                                   (COMP_USB_BUF_START + (320))
#define COMP_EP4_TX1_ADDR                                   (COMP_USB_BUF_START + (384))
#define COMP_EP4_RX0_ADDR                                   (COMP_USB_BUF_START + (320))
#define COMP_EP4_RX1_ADDR                                   (COMP_USB_BUF_START + (384))
...
#define COMP_EP2_TX_FIFO_ADDR_FS                            (640)
#define COMP_EP2_TX_FIFO_SIZE_FS                            (COMP_EP2_TX_SIZE * 4)
#define COMP_EP4_TX_FIFO_ADDR_FS                            (896)
#define COMP_EP4_TX_FIFO_SIZE_FS                            (COMP_EP4_TX_SIZE * 4)
// EndPoints init function for USB OTG core
#if defined(USB_OTG_FS)
#define COMP_TUSB_INIT_EP_OTG_FS(dev) \
